  ...
  describe('#getUserPosts()', function () {
    ...
    describe('Given "leettech"', function () {
      it('returns an array', function (done) {
        timeLine.getUserPosts('leettech').then(function (result) {
    ...
    describe('Given "asdasd" (invalid username)', function () {
      it('returns an empty array', function (done) {
        timeLine.getUserPosts('asdasd').then(function (result) {
          expect(result).to.be.an('array');
    ...
    describe('Given ["leettech", "image"]', function () {
      it('returns an array', function (done) {
        timeLine.getUserPosts('leettech', 'image').then(function (result) {
          expect(result).to.be.an('array');
          done();
        });
      });
    ...
    describe('Given ["leettech", "video"]', function () {
      it('returns an array', function (done) {
        timeLine.getUserPosts('leettech', 'video').then(function (result) {
          expect(result).to.be.an('array');
          done();
        });
      });
    ...
    describe('Given ["leettech", "asdasd"]', function () {
      it('returns an empty array', function (done) {
        timeLine.getUserPosts('leettech', 'asdasd').then(function (result) {
          expect(result).to.be.an('array');
          expect(result).to.be.empty;
          done();
        });
